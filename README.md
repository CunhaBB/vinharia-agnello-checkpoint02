...
Classificação automática do vinho por safra
Alerta de estoque baixo
Relatório final com resumo dos dados
Funcionamento dos Botões
Botão: Cadastrar Vinho

Ao clicar no botão de cadastro:

O sistema inicia um loop de cadastro
O usuário deve inserir:
Nome do vinho
Tipo (tinto, branco, rosé, etc.)
Safra (ano)
Quantidade em estoque
O sistema faz automaticamente:
Validação dos dados inseridos
Classificação do vinho com base na idade:

Link github pages: https://cunhabb.github.io/vinharia-agnello-checkpoint02/
